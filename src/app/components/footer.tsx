  ...
  return (
    <section className='text-center w-full border-t-[1px] border-[#f8d0a8] h-96' >
        ...
        <div className='text-3xl flex flex-col gap-6'>
                <p>Email at</p>
                <Link href="https://mail.google.com/mail/u/1/?pli=1#inbox?compose=CllgCJfrtHZJNQCJxxRvmqlJTRrBBNjCmvXklQjFsgKVrjwxjmwfGFfGSdtdCBdCQSjnBfhrqJV" target="_blank" className='text-[#fac08f] hover:text-[#f8d0a8] duration-500 max-sm:text-2xl'>nbagirovdev@gmail.com</Link>
            </div>
            <div className='text-3xl flex flex-col gap-6'>
                <p>Call at </p>
                <Link href="tel: +994556680619" target="_blank" className='text-[#fac08f] hover:text-[#f8d0a8] duration-500 max-sm:text-2xl'>+994556680619</Link>
            </div>
            <div className='text-3xl flex flex-col gap-6'>
                <p>Follow Me </p>
