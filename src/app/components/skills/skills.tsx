...
function Skills() {
  return (
    <div className='w-full flex justify-center items-center h-screen relative bg-gray-900'>
        <div className='relative flex flex-wrap justify-center items-center w-full h-full max-sm:gap-10 '>
            <div className='absolute top-24 left-52 transform animate-bounce max-sm:top-80'>
            ...
            <div className='absolute top-96 left-20 transform animate-bounce max-sm:left-0 max-sm:top-1/2'>
            ...
            <div className='absolute top-3/4 left-52 transform animate-bounce'>
                <Image src={'/Next_JS.png'} width={100} height={100} alt='Next.js' />
            </div>
            <div className='absolute top-24 right-52 transform animate-bounce max-sm:top-80'>
            ...
            <div className='absolute top-96 right-20 transform animate-bounce max-sm:right-0 max-sm:bottom-30 '>
            ...
            <div className='absolute top-3/4 right-52 transform animate-bounce'>
